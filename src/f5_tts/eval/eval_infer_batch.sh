...
# e.g. F5-TTS, 16 NFE
accelerate launch src/f5_tts/eval/eval_infer_batch.py -s 0 -n "F5TTS_Base_rl" -t "seedtts_test_zh" -nfe 16 -d WenetSpeech4TTS_Basic -c 800
# accelerate launch src/f5_tts/eval/eval_infer_batch.py -s 0 -n "F5TTS_Base" -t "seedtts_test_zh" -nfe 16 -d WenetSpeech4TTS_Basic
